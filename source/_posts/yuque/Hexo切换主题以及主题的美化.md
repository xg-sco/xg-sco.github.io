---
title: Hexo切换主题以及主题的美化
urlname: gzg5d64caz3rhmve
date: '2023-02-07 22:20:31 +0800'
<br />tags:
  - hexo
categories:
  - hexo
...
```
E:\Code\Blog\hexo-blog>git clone git@github.com:litten/hexo-theme-yilia.git themes/yilia
```

## 修改配置

将 theme 的参数修改成 yilia, 然后报错
...
修改了主题不会立马生效, 我们可以喝杯茶, 抽根烟耐心等待下

另外推荐的主题:
quiet
doc: [https://github.com/79E/hexo-theme-quiet](https://github.com/79E/hexo-theme-quiet)
fluid
demo: [https://hexo.fluid-dev.com/](https://hexo.fluid-dev.com/)
doc: [https://hexo.fluid-dev.com/docs/start/](https://hexo.fluid-dev.com/docs/start/)
easyhexo
demo: [https://easyhexo.com/](https://easyhexo.com/)

## 更换网站的 title

在\_config.yaml 直接修改 title 的值
...
![](https://cdn.xiamu.icu//FgWYqR8PjhEj-19SqJinqgPN0Gni.png)
把图片下载下来到 themes/fluid/source/img
在\_config.fluid.yaml 中引入下载好的图片

```
# 用于浏览器标签的图标
# Icon for browser tab
favicon: /img/smile.png
# /img/fluid.png
```
...
![](https://cdn.xiamu.icu//FgUip989myK97CmIxpebp5S0dQzD.png)
...
保存预览, 文本选中的样式就发生了变化
![](https://cdn.xiamu.icu//Fhmi0cH-GbbonE7poyfQQxZQzuGO.png)

## url 的设置

doc: [https://hexo.io/docs/configuration.html](https://hexo.io/docs/configuration.html)

```
# URL
## Set your site url here. For example, if you use GitHub Page, set url as 'https://username.github.io/project'
url: http://roudoukou.github.io
...
然后在主题配置文件\_config.fluid.yml 中引入 sakura.js
...
custom_js:
  - /js/custom.js
  # - /js/sakura.js # 樱花飘落效果
  - /js/snowflake.min.js # 雪花飘落效果
```

参考:

- [https://emoryhuang.cn/blog/1729600336.html](https://emoryhuang.cn/blog/1729600336.html)
- [https://cloud.tencent.com/developer/article/1943699](https://cloud.tencent.com/developer/article/1943699)
...
实现效果:
![](https://cdn.xiamu.icu//Fofwg5BHxYx2RkI-b8za5NOGwDhV.png)
参考:

- 字符画生成 [http://patorjk.com/software/taag/](http://patorjk.com/software/taag/)
- 字符画的写入 [https://blog.51cto.com/u_15127657/4125297](https://blog.51cto.com/u_15127657/4125297)

## 添加评论功能

这里是用的是 Valine 服务提供的评论
设置如下配置开启 valine
...
appId, appKey 需要从 [leancloud](https://console.leancloud.cn/) 中注册获取
设置 - 应用凭证 - Credentials
![](https://cdn.xiamu.icu//FjyfXEUFJtGQ1X_XhP59o1XowZe_.png)

邮箱通知

1. 先创建一个应用
2. 推荐使用这个分支 [https://github.com/billchen2k/Valine-Admin](https://github.com/billchen2k/Valine-Admin) 来创建部署环境
3. 设置 - 域名绑定
4. 配置环境变量

![](https://cdn.xiamu.icu//FqrImt2DzhF-I-lUvkn3tFWmKjKT.png)

5. 创建定时任务

参考:

- [https://fluid-dev.github.io/hexo-fluid-docs/guide/#%E8%AF%84%E8%AE%BA](https://fluid-dev.github.io/hexo-fluid-docs/guide/#%E8%AF%84%E8%AE%BA)
- [https://valine.js.org/](https://valine.js.org/)
- [https://blog.2broear.com/notes/11-04-2020_valine-emoji-addon#642901201abe031ff71dea4f](https://blog.2broear.com/notes/11-04-2020_valine-emoji-addon#642901201abe031ff71dea4f)
- leancloud: [https://console.leancloud.cn/apps](https://console.leancloud.cn/apps)
- [https://github.com/DesertsP/Valine-Admin#%E8%AF%84%E8%AE%BA%E7%AE%A1%E7%90%86](https://github.com/DesertsP/Valine-Admin#%E8%AF%84%E8%AE%BA%E7%AE%A1%E7%90%86)
- [https://github.com/zhaojun1998/Valine-Admin](https://github.com/zhaojun1998/Valine-Admin)
- 推荐使用这个分支: [https://github.com/billchen2k/Valine-Admin](https://github.com/billchen2k/Valine-Admin)

## Tips

> 算是踩的一个大坑了, 折腾了一晚上了
> 2023 年 4 月 1 日 23:14:13

日常使用 markdown 的写文章时, 不要向内容写 web 标签, 尽管 markdown 能正常展示
![](https://cdn.xiamu.icu//FrKClLmwIwv21TeGI_rk8i2xenGL.png)
一旦部署到 hexo 就会出现被解析, 就会导致后面的内容无法展示
![](https://cdn.xiamu.icu//FtTlyu4pN39zmGLR4W8EfSN_Rm1n.png)
